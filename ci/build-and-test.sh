#!/bin/bash
#
# This script builds epicchain-cli with dotnet 2.0, and runs the tests.
#
CONTAINER_NAME="epicchain-cli-ci"
...
# Build the Docker image (includes building the current epicchain-cli code)
