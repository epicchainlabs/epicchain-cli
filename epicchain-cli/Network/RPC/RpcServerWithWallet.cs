                ...
                case "invokescript":
                    ...
                    if (Program.Wallet != null)
                    {
                        InvocationTransaction tx = new InvocationTransaction
                        {
                            ...
                            EpicPulse = Fixed8.Parse(result["epicpulse_consumed"].AsString())
                        };
                        tx.EpicPulse -= Fixed8.FromDecimal(10);
                        if (tx.EpicPulse < Fixed8.Zero) tx.EpicPulse = Fixed8.Zero;
                        tx.EpicPulse = tx.EpicPulse.Ceiling();
